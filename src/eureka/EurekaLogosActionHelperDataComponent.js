...
export default function EurekaLogosActionHelperDataComponent({ logosAction, selectedRecipe, handleRecipeUpdate }) {
  /**
   * Component State
   */
  ...
  // Fetch price data
  if (selectedRecipe) {
    const recipeLogograms = selectedRecipe.map(i => {
