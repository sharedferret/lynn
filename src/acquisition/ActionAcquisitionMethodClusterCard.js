  ...
  return (
    <Card sx={{ minWidth: 275, minHeight: 300 }}>
      <CardContent>
        ...
        <Typography>Exchange { methodData.clusters } Cluster{ methodData.clusters > 1 ? 's' : '' }</Typography>
        <Typography>for { methodData.quantity } Fragment{methodData.quantity > 1 ? 's' : ''}</Typography>
      </CardContent>
    </Card>
  );
}
